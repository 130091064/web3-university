      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex shrink-0 items-center">
          ...
          >
            ...
            <span
              className={
                isWrongNetwork ? 'text-[11px] text-amber-800' : 'text-[11px] text-slate-500'
              }
            >
              {renderChainLabel()}
            </span>
            ...
            {isWrongNetwork && (
              <>
                <span className="hidden text-[11px] text-amber-700 sm:inline">未支持</span>
                <button
            ...
            {!isConnected ? (
              ...
              <div className="flex items-center gap-2">
                {ensAvatar && (
                  <img src={ensAvatar} alt="avatar" className="h-5 w-5 rounded-full object-cover" />
                )}
